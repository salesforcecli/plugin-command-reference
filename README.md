...
_See code: [src/commands/commandreference/generate.ts](https://github.com/salesforcecli/plugin-command-reference/blob/v2.0.2/src/commands/commandreference/generate.ts)_
<!-- commandsstop -->
